            ...
            <div class="col-md-10 col-md-offset-1">
                ...
                <div class="box">
                    ...
                    <div style="font-size: x-large;text-align: center;">
                        <h2 class="box-title">{{$bebida->descricao}}</h2>
                    </div>
                    ...
                    <div class="box-body">
                        ...
                        <div class="jumbotron">
                            ...
                            <div style="border-style: solid; padding: 5px;border-color: white; font-size: large">
                                <strong>Quantidade: </strong> {{$bebida->quantidade}}<br>
                                <strong>Valor: </strong> {{$bebida->valor}}<br>
                                <strong>Tipo: </strong> {{$bebida->tipo}}<br>
                            </div>

                        </div>
                        <a href="{{route('bebida.index')}}" class="btn btn-small btn-primary pull-right btn-lg" style="float: right">
                            Voltar
                        </a>
