        ...
        <div class="row">
                ...
                <div class="box">
                    ...
                    <div class="box-header with-border" align="center">
                        ...
                        <a href="{{route('cliente.create')}}" class="btn btn-small btn-primary col-md-12">
                            ...
                            <thead>
                                ...
                                @foreach($cliente as $c)
                                    <tr>
                                        <td>{{$c->nome}}</td>
                                        <td align="right">
                                            <a href="{{route('cliente.show',$c->codigo)}}" class="btn btn-small btn-info">
                                                <i class="fa fa-search-plus"></i>
                                                Detalhes
                                            </a>
                                            <a href="{{route('cliente.edit',$c->codigo)}}" class="btn btn-small btn-default" style="background-color: goldenrod;color: white">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body text-center">
                                                            <p>Deseja realmente excluir o Cliente {{$c->nome}}?</p>
                                                        </div>
