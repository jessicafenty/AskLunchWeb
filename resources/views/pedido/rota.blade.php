...
@section('htmlheader_title')
    Gerenciamento de Pedidos - Pedidos em Andamento
@endsection
                            ...
                            <thead>
                                ...
                                @foreach($pedido as $c)
                                    <tr class="center">
                                        ...
                                        <td>{{$c->status}}</td>
                                        <td align="right">
                                            <a href="{{route('pedido.finalizar',$c->codigo)}}" class="btn btn-small btn-success">
                                                {{--<i class="fa fa-check-circle-o"></i>--}}
                                                Finalizar
                                            </a>
                                            <a href="{{route('pedido.extraviado',$c->codigo)}}" class="btn btn-small btn-danger">
                                                {{--<i class="fa fa-ban"></i>--}}
                                                Extraviado
                                            </a>
                                        </td>
